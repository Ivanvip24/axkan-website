...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/axkan.mx',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/axkan.mx',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'WhatsApp',
    href: 'https://wa.me/5215538253251',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TikTok',
    href: 'https://tiktok.com/@axkan.mx',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer id="contacto" className="bg-obsidiana text-white">
      {/* CTA Section */}
      <div className="border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-gradient-to-r from-axkan-magenta to-axkan-rojo rounded-2xl p-8 md:p-12 text-center">
            <h3 className="text-3xl md:text-4xl font-bold font-display mb-4">
              ¿Listo para despertar orgullo mexicano?
            </h3>
            <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
              Contáctanos para pedidos especiales, mayoreo o personalización.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="mailto:hola@axkan.mx"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all"
              >
                hola@axkan.mx
              </Link>
            </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <Link
                  ...
                  href={social.href}
                  target="_blank"
                  className="text-white/60 hover:text-axkan-turquesa transition-colors"
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/40">
            <p>© {new Date().getFullYear()} AXKAN by VT Anunciando. Todos los derechos reservados.</p>
